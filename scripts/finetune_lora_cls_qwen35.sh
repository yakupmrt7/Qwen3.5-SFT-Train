#!/usr/bin/env bash
#SBATCH --job-name=qwen35-cls-lora
...
#SBATCH --output=/arf/scratch/aalatan/Re-CoT/Qwen-VL-Series-Finetune/output/qwen35-cls-lora-%j.out
#SBATCH --error=/arf/scratch/aalatan/Re-CoT/Qwen-VL-Series-Finetune/output/qwen35-cls-lora-%j.err
...
DATA=/arf/scratch/aalatan/Re-CoT/datasets/CLS_sft/cls_sft.json
IMAGE_FOLDER=/arf/scratch/aalatan/Re-CoT/datasets/CLS_sft     # image field is "images/<name>", resolved under here
OUTPUT_DIR=$REPO/output/qwen35-cls-lora
