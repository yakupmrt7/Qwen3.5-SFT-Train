...
# Stage 2: chain-of-thought training on top of the merged VG SFT model.
# A fresh LoRA adapter is trained over qwen35-vg-merged (base weights frozen).
...
MODEL=$REPO/output/qwen35-vg-merged                                        # stage-1 SFT model, LoRA already merged in
DATA=/arf/scratch/aalatan/Re-CoT/datasets/reasoning/VG/vg_sft_reasoning.json
IMAGE_FOLDER=/arf/scratch/aalatan/Re-CoT/datasets/reasoning/VG/images      # image field is "<DATASET>/<name>", resolved under here
OUTPUT_DIR=$REPO/output/qwen35-cot-vg-lora
